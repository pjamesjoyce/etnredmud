...
def home(request):
    ...
    args['latestBlog'] = redmudLatestBlog("http://etn.redmud.org/blog/")
...
def redmudLatestBlog(url):
    ...
    titleXPath = '//article/div[2]/h3/a/text()'
    linkXPath = '//article/div[2]/h3/a/@href'
    imgXpath = '//article/div[1]/a/img/@src'
    titles = tree.xpath(titleXPath)
    links = tree.xpath(linkXPath)
    images = tree.xpath(imgXpath)
